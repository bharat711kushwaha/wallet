      ...
      <header className="relative z-10 pt-8 pb-4 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center space-x-2 bg-white bg-opacity-80 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-gray-200 mb-6">
            ...
            <span className="text-sm bg-blue-100 text-blue-800 px-2 py-1 rounded-full">v1.0</span>
          </div>
...
// src/App.tsx - Smart Switching Version
import React from 'react';
import TokenPocketWalletConnector from './components/TokenPocketWalletConnector';
...
const App: React.FC = () => {
  const { isConnected } = useTokenPocket();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      {/* Main Content - Smart Switching */}
      <main className="relative z-10 px-4 pb-12">
        {!isConnected ? (
          // Show connector when not connected
